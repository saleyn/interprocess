   ...
   >
{
   ...
   struct node_pool
   {
      typedef
        ipcdetail::shared_node_pool
          <SegmentManager, sizeof_value<T>::value, NodesPerBlock, WithLocking>
        type;
   ...
   struct rebind
   {
      typedef
        node_allocator_base
          <Version, T2, SegmentManager, NodesPerBlock, PersistentPool,
           WithLocking>
        other;
   };
   ...
   node_allocator_base& operator=
      (const node_allocator_base
             <Version2, T2, SegmentManager2, N2, PersPool2, WLock2>&);
   ...
   /// @endcond
{
   ...
   typedef
     ipcdetail::node_allocator_base
       <2, T, SegmentManager, NodesPerBlock, PersistentPool, WithLocking>
     base_t;
